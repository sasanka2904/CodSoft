...
class Todo:
    def __init__(self, master):
        ...
        self.task_entry.grid(row=0, column=0, padx=10, sticky="ew")
        ...
        self.delete_button.grid(row=2, column=0, padx=10, sticky="ew")

        self.save_button = ttk.Button(self.frame, text="Save Tasks", command=self.save_tasks)
        self.save_button.grid(row=2, column=1, padx=10, sticky="ew")
